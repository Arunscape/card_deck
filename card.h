...
public:
  ...
  // Compares if the card face value of the left card is less than or equal the
  // right. Does not take suit into consideration.
  //
  // @param[in]	rhs   The right hand side card.
  ...
  // Compares if the card face value of the left card is greater than or equal
  // the right. Does not take suit into consideration.
  //
  // @param[in]	rhs   The right hand side card.
